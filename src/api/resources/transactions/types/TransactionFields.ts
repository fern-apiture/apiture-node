...
export interface TransactionFields {
    ...
    id: string;
    type: ApitureApi.TransactionType;
    subtype: ApitureApi.TransactionSubType;
    ...
    postedOn?: string;
    amount: ApitureApi.CreditOrDebitValue;
    ...
    posted?: boolean;
    balance?: ApitureApi.CreditOrDebitValue;
    /** The user-settable transaction memo. */
    memo?: string;
    /** The transaction description assigned by the transaction cleansing service. */
    description?: string;
    category?: ApitureApi.TransactionCategorization;
    merchant?: ApitureApi.TransactionMerchant;
    check?: ApitureApi.TransactionCheck;
}
