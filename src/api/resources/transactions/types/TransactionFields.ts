...
export interface TransactionFields {
    ...
    id: string;
    type: Apiture.TransactionType;
    subtype: Apiture.TransactionSubType;
    ...
    postedOn?: string;
    amount: Apiture.CreditOrDebitValue;
    ...
    posted?: boolean;
    balance?: Apiture.CreditOrDebitValue;
    /** The user-settable transaction memo. */
    memo?: string;
    /** The transaction description assigned by the transaction cleansing service. */
    description?: string;
    category?: Apiture.TransactionCategorization;
    merchant?: Apiture.TransactionMerchant;
    check?: Apiture.TransactionCheck;
}
