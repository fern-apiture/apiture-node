...
export interface ListTransactionsRequest {
     ...
     */
    category?: Apiture.TransactionCategoryLabel | Apiture.TransactionCategoryLabel[];
    /**
     * Filter transactions to only those whose `type` is in this pipe-separated list.
     */
    type?: Apiture.TransactionType | Apiture.TransactionType[];
    /**
     * Filter transactions to only those whose `subtype` is in this pipe-separated list.
     */
    subtype?: Apiture.TransactionSubType | Apiture.TransactionSubType[];
    /**
