...
/**
 * Describes the risk level of a payment batch's settlement account. <strong><code>achAccountRisk</code></strong> strings may have one of the following [enumerated values](https://dx.apiture.com/docs/api-documentation/concepts/label-groups#enumerations): <table> <tr>
