...
export interface AccountBalance {
    ...
    available?: ApitureBanking.CreditOrDebitValue;
    ...
    current?: ApitureBanking.CreditOrDebitValue;
    updatedAt?: ApitureBanking.ReadOnlyTimestamp;
    /** The current balance, with posted transactions. This is the string representation of the exact decimal amount. */
    currentWithPending?: ApitureBanking.CreditOrDebitValue;
